...
import { CheckCircle, Scale, Calendar, Target, ExternalLink, GraduationCap, Monitor } from "lucide-react";
import { useLocation } from "wouter";

export default function ISO37301() {
  const { t } = useLanguage();
  const [, navigate] = useLocation();

  const benefits = [
    t('establishesComplianceCulture'),
    t('ensuresRegulatoryComplianceCompliance'),
    t('reducesComplianceRisks'),
    t('improvesStakeholderTrust'),
    t('enhancesGovernancePractices'),
    t('facilitatesBusinessOperations')
  ];
  ...
  const process = [
    {
      ...
      description: "Optional Gap Analysis to assess current compliance management state and identify improvement areas."
    },
    {
      step: "2", 
      title: "Stage 1 Certification Audit",
      description: "Document review to evaluate alignment with ISO 37301:2021 requirements and readiness assessment."
    },
    {
      step: "3",
      title: "Stage 2 Certification Audit",
      description: "Implementation evaluation through staff interviews, process observation, and compliance practice verification."
    },
    {
      step: "4",
  ...
  return (
    <div className="min-h-screen">
      ...
      <main className="pt-20">
        {/* Hero Section */}
        <section className="relative bg-gradient-to-br from-emerald-800 to-emerald-600 text-white py-20 overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              <Scale className="h-20 w-20 text-emerald-300 mx-auto mb-8" />
              <h1 className="text-5xl font-bold mb-6">ISO 37301:2021</h1>
              <h2 className="text-2xl font-light mb-8 text-emerald-100">{t('complianceManagementSystems')}</h2>
              <p className="text-xl text-emerald-100 max-w-4xl mx-auto leading-relaxed">
                {t('establishCultureCompliance')}
              </p>
            </div>
          </div>
        </section>
                ...
                <Card className="hover-lift border-emerald-200">
                  <CardContent className="p-8">
                    <div className="text-center">
                      ...
                      <p className="text-3xl font-bold text-emerald-600 mb-2">ISO 37301:2021</p>
                    </div>
                  </CardContent>
                </Card>
              </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-700 max-w-3xl mx-auto">
                ISO 37301:2021 certification provides comprehensive compliance management advantages
              </p>
            </div>
            
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {benefits.map((benefit, index) => (
                <Card key={index} className="hover-lift border-emerald-200">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <div className="max-w-4xl mx-auto text-lg text-gray-700 leading-relaxed space-y-4">
                <p>
                  Certification demonstrates commitment to compliance excellence, essential for 
                  regulated industries and organizations operating in multiple jurisdictions.
                </p>
                <p>
                  ISO 37301 certification provides assurance to stakeholders that compliance risks 
                  are systematically identified, assessed, and managed throughout the organization.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {process.map((step, index) => (
                <Card key={index} className="hover-lift">
                  <CardContent className="p-6">
                    <div className="text-center">
                      <div className="bg-emerald-600 text-white text-xl font-bold w-10 h-10 rounded-full flex items-center justify-center mx-auto mb-4">
                        {step.step}
                      </div>
...
{t('masterIso37301Training')}
              ...
              <Card className="hover-lift">
                <CardContent className="p-6 text-center">
                  ...
                  <p className="text-gray-600 mb-4">
                    {t('transformComplianceManagement')}
                  </p>
                  <Button 
                    variant="outline"
        ...
        <section className="py-16 bg-emerald-600 text-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              <h2 className="text-4xl font-bold mb-6">Ready for Compliance Excellence?</h2>
              <p className="text-xl mb-8 max-w-3xl mx-auto">
                Start your compliance management system certification with QSI today
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <Button 
                  ...
                  onClick={() => navigate('/contact?context=certification&source=37301:2021')}
                >
                  Contact Our Experts
                </Button>
              </div>
