...
export default function ISO18788() {
  ...
  const benefits = [
    t('ensuresResponsibleSecurityService'),
    t('enhancesComplianceInternational'),
    t('buildsTrustClientsStakeholders'),
    t('reducesOperationalReputationalRisks'),
    t('promotesHumanRightsEthical'),
    t('improvesCompetitiveAdvantageSecurity')
  ];
  ...
  const process = [
    {
      ...
      description: t('optionalGapAnalysis')
    },
    {
      step: "2", 
      title: t('stage1CertificationAudit'),
      description: t('documentReviewEvaluate')
    },
    {
      step: "3",
      title: t('stage2CertificationAudit'),
      description: t('implementationEvaluationStaff')
    },
    {
      step: "4",
  ...
  return (
    <div className="min-h-screen">
      ...
      <main className="pt-20">
        {/* Hero Section */}
        <section className="relative bg-gradient-to-br from-gray-800 to-gray-600 text-white py-20 overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              <Shield className="h-20 w-20 text-gray-300 mx-auto mb-8" />
              <h1 className="text-5xl font-bold mb-6">ISO 18788:2015</h1>
              <h2 className="text-2xl font-light mb-8 text-gray-100">{t('privateSecurityOperationsManagement')}</h2>
              <p className="text-xl text-gray-100 max-w-4xl mx-auto leading-relaxed">
                {t('ensureResponsibleSecurity')}
              </p>
            </div>
          </div>
        </section>
                ...
                <Card className="hover-lift border-gray-200">
                  <CardContent className="p-8">
                    <div className="text-center">
                      ...
                      <p className="text-3xl font-bold text-gray-600 mb-2">{t('iso18788LatestVersion')}</p>
                    </div>
                  </CardContent>
                </Card>
              </div>
        ...
        {/* Key Benefits */}
        <section className="py-16 bg-qsi-navy text-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-4xl font-bold text-white mb-6">{t('keyBenefits')}</h2>
              <p className="text-xl text-gray-100 max-w-3xl mx-auto">
                {t('iso18788BenefitsDesc')}
              </p>
            </div>
            
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {benefits.map((benefit, index) => (
                <Card key={index} className="hover-lift border-white/20 bg-white/10 backdrop-blur-sm">
        ...
        {/* Why Get Certified */}
        <section className="py-16 bg-qsi-orange text-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-4xl font-bold text-white mb-6">{t('whyCertify')}</h2>
              <div className="max-w-4xl mx-auto text-lg text-gray-100 leading-relaxed space-y-4">
                <p>
                  {t('iso18788WhyCertify1')}
                </p>
                <p>
                  {t('iso18788WhyCertify2')}
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {process.map((step, index) => (
                <Card key={index} className="hover-lift border-qsi-orange/20">
                  <CardContent className="p-6">
                    <div className="text-center">
                      <div className="bg-qsi-orange text-white text-xl font-bold w-10 h-10 rounded-full flex items-center justify-center mx-auto mb-4">
                        {step.step}
                      </div>
        ...
        <section className="py-16 bg-qsi-navy text-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              <h2 className="text-4xl font-bold mb-6">{t('readyForSecurityExcellence')}</h2>
              <p className="text-xl mb-8 max-w-3xl mx-auto">
                {t('startSecurityManagementJourney')}
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                >
                  {t('getQuote')} <ExternalLink className="ml-2 h-5 w-5" />
                </Button>
                <Button 
                  size="lg"
                  variant="outline"
                  ...
                  onClick={() => navigate('/contact?context=certification&source=18788:2015')}
                >
                  {t('contactExperts')}
                </Button>
              </div>
