...
export default function ISO9001() {
  ...
  const benefits = [
    t('improvesCustomerSatisfaction'),
    t('enhancesProcessEfficiency'),
    t('reducesWasteOperationalCosts'),
    t('strengthensSupplierRelationships'),
    t('facilitatesRiskManagement'),
    t('supportsContinuousImprovement')
  ];
    ...
    <div className="min-h-screen">
      ...
      <main className="pt-20">
        ...
        <section className="relative bg-gradient-to-br from-blue-800 to-blue-600 text-white py-20 overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              <Award className="h-20 w-20 text-blue-300 mx-auto mb-8" />
              <h1 className="text-5xl font-bold mb-6">ISO 9001:2015</h1>
              <h2 className="text-2xl font-light mb-8 text-blue-100">{t('qualityManagementSystems')}</h2>
              <p className="text-xl text-blue-100 max-w-4xl mx-auto leading-relaxed">
                {t('buildQualityExcellence')}
              </p>
            </div>
          </div>
        </section>
                ...
                <Card className="hover-lift border-blue-200">
                  <CardContent className="p-8">
                    <div className="text-center">
                      ...
                      <h3 className="text-2xl font-semibold text-qsi-navy mb-4">{t('latestVersion')}</h3>
                      <p className="text-3xl font-bold text-blue-600 mb-2">ISO 9001:2015</p>
                      <p className="text-gray-600">Published September 2015</p>
                      <p className="text-sm text-gray-500 mt-2">Next revision under consideration</p>
                    </div>
                  </CardContent>
                </Card>
              </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <div className="max-w-4xl mx-auto text-lg text-gray-700 leading-relaxed space-y-4">
                <p>
                  {t('iso9001WhyCertify1')}
                </p>
                <p>
                  {t('iso9001WhyCertify2')}
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="py-16 bg-blue-600 text-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              <h2 className="text-4xl font-bold mb-6">{t('readyForQualityExcellence')}</h2>
              <p className="text-xl mb-8 max-w-3xl mx-auto">
                {t('startQualityJourney')}
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <Button 
                  ...
                  onClick={() => navigate('/contact?context=certification&source=9001:2015')}
                >
                  {t('contactExperts')}
                </Button>
              </div>
