...
import { CheckCircle, UtensilsCrossed, Calendar, Target, ExternalLink, GraduationCap, Monitor } from "lucide-react";
...
export default function ISO22000() {
  ...
  const benefits = [
    t('ensuresFoodSafety'),
    t('enhancesConsumerConfidence'),
    t('facilitatesGlobalTrade'),
    t('reducesRecallRisks'),
    t('improvesSupplierManagement'),
    t('demonstratesCommitmentSafety')
  ];
  ...
  const process = [
    {
      ...
      description: "Optional Gap Analysis to assess current food safety management state and identify improvement areas."
    },
    {
      step: "2", 
      title: "Stage 1 Certification Audit",
      description: "Document review to evaluate alignment with ISO 22000:2018 requirements and readiness assessment."
    },
    {
      step: "3",
      title: "Stage 2 Certification Audit",
      description: "Implementation evaluation through staff interviews, facility inspection, and food safety practice verification."
    },
    {
      step: "4",
    ...
    <div className="min-h-screen">
      ...
      <main className="pt-20">
        ...
        <section className="relative bg-gradient-to-br from-blue-800 to-blue-600 text-white py-20 overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              <UtensilsCrossed className="h-20 w-20 text-blue-300 mx-auto mb-8" />
              <h1 className="text-5xl font-bold mb-6">ISO 22000:2018</h1>
              <h2 className="text-2xl font-light mb-8 text-blue-100">{t('foodSafetyManagementSystems')}</h2>
              <p className="text-xl text-blue-100 max-w-4xl mx-auto leading-relaxed">
                {t('ensureFoodSafetySupplyChain')}
              </p>
            </div>
          </div>
        </section>
                ...
                <Card className="hover-lift border-blue-200">
                  <CardContent className="p-8">
                    <div className="text-center">
                      ...
                      <p className="text-3xl font-bold text-blue-600 mb-2">ISO 22000:2018</p>
                    </div>
                  </CardContent>
                </Card>
              </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-700 max-w-3xl mx-auto">
                ISO 22000:2018 certification provides comprehensive food safety management advantages
              </p>
            </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <div className="max-w-4xl mx-auto text-lg text-gray-700 leading-relaxed space-y-4">
                <p>
                  Certification demonstrates commitment to food safety and is often required 
                  for international trade and major retail partnerships.
                </p>
                <p>
                  ISO 22000 certification provides assurance to consumers, regulators, and business 
                  partners that food safety is systematically managed throughout the food chain.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <Card className="hover-lift">
                <CardContent className="p-6 text-center">
                  ...
                  <p className="text-gray-600 mb-4">
                    {t('transformFoodSafetyManagement')}
                  </p>
                  <Button 
                    variant="outline"
        ...
        <section className="py-16 bg-blue-600 text-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              <h2 className="text-4xl font-bold mb-6">Ready for Food Safety Excellence?</h2>
              <p className="text-xl mb-8 max-w-3xl mx-auto">
                Start your food safety management system certification with QSI today
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <Button 
                  size="lg"
                  variant="outline"
                  className="border-2 border-white text-white hover:bg-white hover:text-blue-600 px-8 py-4 text-lg font-semibold bg-white/20 backdrop-blur-sm"
