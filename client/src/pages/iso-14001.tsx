...
import { CheckCircle, Leaf, Calendar, Target, ExternalLink, GraduationCap, Monitor } from "lucide-react";
...
export default function ISO14001() {
  ...
  const benefits = [
    t('reducesEnvironmentalImpact'),
    t('ensuresRegulatoryCompliance'),
    t('improvesResourceEfficiency'),
    t('enhancesCorporateReputation'),
    t('reducesOperatingCosts'),
    t('improvestakeholderRelations')
  ];
    ...
    <div className="min-h-screen">
      ...
      <main className="pt-20">
        ...
        <section className="relative bg-gradient-to-br from-green-800 to-green-600 text-white py-20 overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              <Leaf className="h-20 w-20 text-green-300 mx-auto mb-8" />
              <h1 className="text-5xl font-bold mb-6">ISO 14001:2015</h1>
              <h2 className="text-2xl font-light mb-8 text-green-100">{t('environmentalManagementSystems')}</h2>
              <p className="text-xl text-green-100 max-w-4xl mx-auto leading-relaxed">
                {t('achieveSustainableExcellence')} 
                through internationally recognized environmental management system certification.
              </p>
            </div>
          </div>
        </section>
                ...
                <Card className="hover-lift border-green-200">
                  <CardContent className="p-8">
                    <div className="text-center">
                      ...
                      <p className="text-3xl font-bold text-green-600 mb-2">ISO 14001:2015</p>
                    </div>
                  </CardContent>
                </Card>
              </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-700 max-w-3xl mx-auto">
                {t('iso14001BenefitsDesc')}
              </p>
            </div>
            
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {benefits.map((benefit, index) => (
                <Card key={index} className="hover-lift border-green-200">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <div className="max-w-4xl mx-auto text-lg text-gray-700 leading-relaxed space-y-4">
                <p>
                  {t('iso14001WhyCertify1')}
                </p>
                <p>
                  {t('iso14001WhyCertify2')}
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {process.map((step, index) => (
                <Card key={index} className="hover-lift">
                  <CardContent className="p-6">
                    <div className="text-center">
                      <div className="bg-green-600 text-white text-xl font-bold w-10 h-10 rounded-full flex items-center justify-center mx-auto mb-4">
                        {step.step}
                      </div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <Card className="hover-lift">
                <CardContent className="p-6 text-center">
                  ...
                  <p className="text-gray-600 mb-4">
                    {t('transformEnvironmentalManagement')}
                  </p>
                  <Button 
                    variant="outline"
        ...
        <section className="py-16 bg-green-600 text-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              <h2 className="text-4xl font-bold mb-6">{t('readyForEnvironmentalExcellence')}</h2>
              <p className="text-xl mb-8 max-w-3xl mx-auto">
                {t('startEnvironmentalJourney')}
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <Button 
                  ...
                  onClick={() => navigate('/contact?context=certification&source=14001:2015')}
                >
                  {t('contactExperts')}
                </Button>
              </div>
